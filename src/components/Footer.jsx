...
function Footer() {
  return (
    <footer className="glass-effect mt-auto border-t elegant-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/all-products" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Colección
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/orders" className="text-gray-400 hover:text-amber-400 transition-colors">
                  Mis Pedidos
                </Link>
              </li>
            </ul>
        ...
        {/* Copyright */}
        <div className="border-t border-amber-900/30 mt-8 pt-8 text-center">
